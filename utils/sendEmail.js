...
const transporter = createTransport({
    ...
    auth: {
      ...
      user: 'askermostafa87@gmail.com',
      pass: 'lqvvsgymhbvwomxn'
    },
    tls: {
...
async function sendEmail(option) {
    ...
    const info = await transporter.sendMail({
      from: '"Mostafa Askar 👻" <askermostafa87@gmail.com>', // sender address
